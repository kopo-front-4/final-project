...
const AfterServicePage = () => {
  ...
  return (
    <>
      <header className="fixed top-0 pt-5 w-full flex justify-center">
        <ul className="flex gap-10">
          <li className="cursor-pointer">처음으로</li>
          <li className="cursor-pointer">운세결과</li>
          <li className="cursor-pointer">서비스</li>
          <li className="cursor-pointer">연락</li>
        </ul>
      </header>
